package com.xingyun.springbootwithlog4j2sample;
...
public class SpringBootWithLog4j2SampleApplication {

    public static void main(String[] args) {
        //SpringApplication.run方法会构建一个Spring容器,并且返回一个ApplicationContext对象,也就是项目的上下文
        SpringApplication.run(SpringBootWithLog4j2SampleApplication.class, args);
    }
